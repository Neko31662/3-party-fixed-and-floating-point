...
//     (l == ShareValue_BitLength) ? ~ShareValue(0) : ((ShareValue(1) << l) - 1);
// template <int l, int lf>
// const ShareValue fixed_point_share<l, lf>::MASK_lf =
//     (lf == ShareValue_BitLength) ? ~ShareValue(0) : ((ShareValue(1) << lf) - 1);
// template <int l, int lf>
// const ShareValue fixed_point_share<l, lf>::MASK_llf =
//     (l + lf == ShareValue_BitLength) ? ~ShareValue(0) : ((ShareValue(1) << (l + lf)) - 1);
...
// //         error("fixed_point_share_mul_res::preprocess requires s1 and s2 to have been
// //         preprocessed");
// //     }
