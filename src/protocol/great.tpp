...
void PI_great_preprocess(const int party_id, std::vector<PRGSync> &PRGs, NetIOMP &netio,
    ...
    MSSshare_p_add_res &b = *output_b;
    std::vector<PI_sign_intermediate<ell, k>> &sign_intermediate = intermediate.sign_intermediate;
